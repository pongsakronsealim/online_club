...
class PrintClubController extends Controller
{
    public function actionPrint()
    {
      ...
      $content = $this->renderPartial('//backend/print-club/club', [
        'model' => $model,
        'model_std' => $model_std,
    ...
    public function actionActivities($id)
    {
      ...
      $content = $this->renderPartial('//backend/print-club/activities', [
        'model' => $model,
        'model_ac' => $model_ac,
        'dataProvider' => $dataProvider,
      ]);
    ...
    public function actionClub()
    {
      ...
      $content = $this->renderPartial('//backend/print-club/list_club', [
        'dataProvider' => $dataProvider,
      ]);
